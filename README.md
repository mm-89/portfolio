# Michele Marro – Project Portfolio

Welcome to my GitHub portfolio!

Here you’ll find a selection of personal and research projects spanning **data analysis, modeling, analog photography, and aeronautics**.
...
## 🔧 Notes
- Each project repository contains **documentation, images, and code**.  
- Some projects are **research-oriented**, others are **personal or experimental**.  
- Visual projects (like **pinhole-project** or **sundial-generator**) include **screenshots and gallery folders**.  
- All links are relative to the repository root for easy navigation.

---

## 💡 Tips for Browsing
- Use the **icons** to quickly identify project type.  
- Open the **Gallery or PDF links** for detailed visual or technical documentation.  
- Each project is independent, so feel free to clone or explore separately.
